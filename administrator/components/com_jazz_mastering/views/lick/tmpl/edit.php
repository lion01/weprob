...
<script type="text/javascript">
	...
	{
		if (task == 'lick.cancel' || document.formvalidator.isValid(document.id('lick-form'))) {
			Joomla.submitform(task, document.getElementById('lick-form'));
		}
		else {
...
<form action="<?php echo JRoute::_('index.php?option=com_jazz_mastering&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lick-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo JText::_('COM_JAZZ_MASTERING_LEGEND_LICK'); ?></legend>
