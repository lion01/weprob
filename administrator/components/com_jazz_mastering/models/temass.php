...
class Jazz_masteringModeltemass extends JModelList
{
    ...
    public function __construct($config = array())
    {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'compases', 'a.compases',
                'user', 'a.user',
                'fecha_de_creacion', 'a.fecha_de_creacion',
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		//Filtering tempo
		$this->setState('filter.tempo', $app->getUserStateFromRequest($this->context.'.filter.tempo', 'filter_tempo', '', 'string'));

		//Filtering estilo
		$this->setState('filter.estilo', $app->getUserStateFromRequest($this->context.'.filter.estilo', 'filter_estilo', '', 'string'));

		//Filtering tonalidad
		$this->setState('filter.tonalidad', $app->getUserStateFromRequest($this->context.'.filter.tonalidad', 'filter_tonalidad', '', 'string'));
