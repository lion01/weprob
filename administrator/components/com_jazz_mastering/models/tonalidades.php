...
class Jazz_masteringModeltonalidades extends JModelList
{
    ...
    public function __construct($config = array())
    {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                                'id', 'a.id',
                'value_tonalidad', 'a.value_tonalidad',
                'value_tonalidad_creado_por', 'a.value_tonalidad_creado_por',
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$this->setState('filter.value_tonalidad_creado_por', $app->getUserStateFromRequest($this->context.'.filter.value_tonalidad_creado_por', 'filter_value_tonalidad_creado_por', '', 'string'));
	...
	protected function getListQuery()
	{
		...
		// Join over the user field 'value_tonalidad_creado_por'
