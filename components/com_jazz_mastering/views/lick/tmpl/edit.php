...
<div class="lick-edit front-end-edit">
    <h1> <?php echo JText::_('COM_JAZZMASTERING_LICK_EDIT_TITTLE') ;
    echo $this->item->id; ?></h1>

    <form id="form-lick" action="<?php echo JRoute::_('index.php?option=com_jazz_mastering&task=lick.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
        		<li><?php echo $this->form->getLabel('img_lick'); ?>
				<?php echo $this->form->getInput('img_lick'); ?></li></ul>
				<br/><br/><br/>
				<ul>
		...
		<div>
			...
			<?php echo JText::_('or'); ?>
			<a href="<?php echo JRoute::_('index.php?option=com_jazz_mastering&task=lick.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

			<input type="hidden" name="option" value="com_jazz_mastering" />
			<input type="hidden" name="task" value="lick.save" />
